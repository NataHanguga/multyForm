...
var AddressComponent = /** @class */ (function () {
    ...
    AddressComponent.prototype.ngOnInit = function () {
        var written = this.service.getData();
        var data = (this.service.getAddress()).value;
    ...
    AddressComponent.prototype.show = function () {
...
var FullNameComponent = /** @class */ (function () {
    function FullNameComponent(service) {
        this.service = service;
        this.fullName = this.service.fullName;
    }
    FullNameComponent.prototype.ngOnInit = function () {
        var written = this.service.getData();
        var data = this.service.getfullName().value;
    ...
    FullNameComponent.prototype.show = function () {
        this.service.setFullName(this.fullName);
    };
    FullNameComponent.prototype.onFileChange = function (event) {
        var _this = this;
        ...
        if (files && files[0]) {
            ...
            reader.onload = function (e) {
                ...
                console.log(e);
                _this.fullName.get('image').setValue(_this.url);
                console.log(files, _this.fullName.value);
            };
        }
    };
    FullNameComponent.ctorParameters = function () { return [
        { type: src_app_services_multi_form_service__WEBPACK_IMPORTED_MODULE_2__["MultiFormService"] }
    ]; };
...
var MultiFormComponent = /** @class */ (function () {
    function MultiFormComponent(router) {
        this.router = router;
    }
    MultiFormComponent.prototype.ngOnInit = function () {
        this.router.navigateByUrl('/');
    };
    MultiFormComponent.ctorParameters = function () { return [
...
var PhoneComponent = /** @class */ (function () {
    ...
    PhoneComponent.prototype.show = function () {
...
var ResultComponent = /** @class */ (function () {
    function ResultComponent(service) {
        this.service = service;
    }
...
var MultiFormService = /** @class */ (function () {
    function MultiFormService(fb) {
        this.fb = fb;
    ...
    MultiFormService.prototype.setFullName = function (data) {
        this.fullName = data;
        this.multyForm.value.fulName = data;
        this.subject.next('fullName');
    };
    MultiFormService.prototype.getData = function () {
        var data = this.subject.value;
        if (data === 'fullName') {
            return 'fullName';
        }
    ...
    MultiFormService.prototype.getfullName = function () {
        return this.fullName;
    };
    MultiFormService.prototype.setAddress = function (data) {
        this.address = data;
        this.multyForm.value.address = this.address;
        this.subject.next('address');
    };
    MultiFormService.prototype.getAddress = function () {
        return this.address;
    };
    MultiFormService.prototype.setPhone = function (data) {
        this.phoneNumber = data;
        this.multyForm.value.phone = this.phoneNumber;
    };
    MultiFormService.prototype.getPhone = function () {
        return this.phoneNumber;
    };
    MultiFormService.prototype.getFullData = function () {
    ...
    // }
    MultiFormService.prototype.reset = function () {
    ...
    MultiFormService.prototype.complete = function () {
    ...
    MultiFormService.ctorParameters = function () { return [
...
var CreateStudentComponent = /** @class */ (function () {
    ...
    CreateStudentComponent.prototype.removeSubject = function (i) {
        this.studentService.removeSubject(i);
    };
    CreateStudentComponent.prototype.save = function (data) {
        this.studentService.saveStudent(data);
        this.cancel();
    };
    CreateStudentComponent.prototype.cancel = function () {
        this.display = false;
        this.teacherForm.reset();
    };
    CreateStudentComponent.ctorParameters = function () { return [
...
var ProgressTableComponent = /** @class */ (function () {
    function ProgressTableComponent() {
        this.arr = [];
        this.PAY = 50;
    }
    ProgressTableComponent.prototype.ngOnInit = function () {
        // console.log(this.pay, this.type);
        this.creatreArray();
    };
    ProgressTableComponent.prototype.creatreArray = function () {
        var date = new Date(this.startDate).getMonth();
...
var ShowStudentsComponent = /** @class */ (function () {
    function ShowStudentsComponent(studentService) {
        this.studentService = studentService;
    }
    ShowStudentsComponent.prototype.ngOnInit = function () {
        this.teacherList = this.studentService.getStudentsFromLocalSrotage();
        // console.log(this.teacherList);
    };
    ShowStudentsComponent.prototype.getStudents = function (event) {
        console.log(event);
        this.studentList.getStudents(event);
    };
    ShowStudentsComponent.prototype.changeSearch = function (data) {
    ...
    ShowStudentsComponent.prototype.changeList = function (event) {
        console.log(event);
        this.teacherList = event;
    };
    ShowStudentsComponent.ctorParameters = function () { return [
        { type: _services_student_service__WEBPACK_IMPORTED_MODULE_2__["StudentService"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var StudentRowComponent = /** @class */ (function () {
    function StudentRowComponent(studentService) {
        this.studentService = studentService;
    ...
    StudentRowComponent.prototype.ngOnInit = function () {
    };
    // edit(teacher: string, student: Teacher) {
    // 	console.log(teacher, student);
    // 	this.studentService.saveTeacher(teacher, student);
    // }
    StudentRowComponent.prototype.getStudents = function (name) {
        this.studentList = this.studentService.getStudentsByTeacherName(name);
        console.log(this.studentList);
    };
    StudentRowComponent.prototype.editStudent = function (teacher, student) {
        console.log(teacher, student);
    ...
    StudentRowComponent.prototype.saveEditStudent = function () {
        console.log(this.fullName, this.classNumber, this.date);
        var editStudent = new _models_showStudent__WEBPACK_IMPORTED_MODULE_2__["ShowStudent"](this.fullName, this.classNumber, this.studentItem.studentType, this.date, this.studentItem.payArray);
    ...
    StudentRowComponent.prototype.cancel = function () {
        this.displayEdit = false;
        this.fullName = null;
        this.classNumber = null;
        this.date = null;
    };
    StudentRowComponent.prototype.payNow = function (data, teacher) {
        this.display = true;
        this.teacherItem = teacher;
        this.studentItem = data;
        console.log(data.fullName, teacher);
    };
    StudentRowComponent.prototype.deleteStudent = function (id, teacher) {
        this.studentService.deleteStudent(id, teacher);
        this.teacherList = this.studentService.getStudentsFromLocalSrotage();
        this.list.emit(this.teacherList);
    };
    StudentRowComponent.prototype.save = function (data) {
        console.log(data);
    ...
    StudentRowComponent.ctorParameters = function () { return [
...
var TeacherCellComponent = /** @class */ (function () {
    function TeacherCellComponent(studentService) {
        this.studentService = studentService;
        this.list = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    ...
    TeacherCellComponent.prototype.ngOnInit = function () {
    };
    TeacherCellComponent.prototype.deleteTeacher = function (teacher) {
        this.studentService.deleteTeacher(teacher);
        this.teacherList = this.studentService.getStudentsFromLocalSrotage();
        this.list.emit(this.teacherList);
    };
    TeacherCellComponent.prototype.show = function (data) {
        console.log(data);
    };
    TeacherCellComponent.prototype.addStudent = function (teacher) {
        this.displayAdd = true;
        this.teacherItem = teacher;
    };
    TeacherCellComponent.prototype.editTeacher = function (teacherEdit) {
        this.display = true;
    ...
    TeacherCellComponent.prototype.saveEditTeacherName = function () {
        console.log(this.teacherItem);
        var newTeacher = new _models_teacher__WEBPACK_IMPORTED_MODULE_2__["Teacher"](this.teacherItem, this.editTeacherItem.student);
    ...
    //   this.student.reset();
    // }
    TeacherCellComponent.prototype.saveNewStudent = function (data) {
        this.displayAdd = false;
    ...
    TeacherCellComponent.prototype.showTeacherChildren = function (teacherName) {
        this.name.emit(teacherName);
    };
    TeacherCellComponent.prototype.changeStudentType = function (student, value) {
        student.studentType = value === null ?
            this.types[0].value : value;
    };
    TeacherCellComponent.ctorParameters = function () { return [
...
var ShowStudent = /** @class */ (function () {
    function ShowStudent(fullName, classNumber, studentType, startDate, payArray) {
    ...
    ShowStudent.ctorParameters = function () { return [
...
var Teacher = /** @class */ (function () {
    function Teacher(teacherName, student) {
...
var FilterPipe = /** @class */ (function () {
    ...
    FilterPipe.prototype.transform = function (items, search) {
        ...
        var data = items.forEach(function (teacher) {
            return teacher.student.filter(function (student) {
...
var StudentService = /** @class */ (function () {
    ...
    StudentService.prototype.initialSubject = function () {
    ...
    StudentService.prototype.addStudent = function () {
        var control = this.teacherForm.controls.students;
        control.push(this.initialSubject());
    };
    StudentService.prototype.removeSubject = function (i) {
        var control = this.teacherForm.controls.students;
        control.removeAt(i);
    };
    StudentService.prototype.saveStudent = function (data) {
        console.log(data.value);
        var arr = data.value.students.map(function (el) {
        ...
        var teacher = new _models_teacher__WEBPACK_IMPORTED_MODULE_3__["Teacher"](data.value.teacherName, arr);
        console.log(teacher);
    ...
    StudentService.prototype.setStudentToLocalStorage = function (student) {
        localStorage.setItem('studentList', JSON.stringify(student));
    };
    StudentService.prototype.getStudentsFromLocalSrotage = function () {
        var data = localStorage.getItem('studentList');
        return data === null ? [] : JSON.parse(data);
    };
    StudentService.prototype.setPayArray = function (id, data, name) {
        console.log(id, data, name);
        this.teacherList = this.getStudentsFromLocalSrotage();
        this.teacherList.map(function (teacher) {
            teacher.student.forEach(function (student, i) {
    ...
    StudentService.prototype.deleteStudent = function (id, teacherName) {
        this.teacherList = this.getStudentsFromLocalSrotage();
        this.teacherList.map(function (teacher) {
            if (teacher.teacherName === teacherName) {
                var index = teacher.student.findIndex(function (el) { return el.id === id; });
                teacher.student.splice(index, 1);
            }
        });
        this.setStudentToLocalStorage(this.teacherList);
    };
    StudentService.prototype.addNewStudent = function (teacherName, student) {
        this.teacherList = this.getStudentsFromLocalSrotage();
        this.teacherList.map(function (teacher) {
            if (teacher.teacherName === teacherName) {
    ...
    StudentService.prototype.saveEditTeacher = function (newTeacher) {
        this.teacherList = this.getStudentsFromLocalSrotage();
        this.teacherList.map(function (teacher) {
    ...
    StudentService.prototype.saveEditStudent = function (editStudent) {
        this.teacherList = this.getStudentsFromLocalSrotage();
        this.teacherList.map(function (teacher) {
            teacher.student.forEach(function (student) {
    ...
    StudentService.prototype.deleteTeacher = function (teacherDel) {
        this.teacherList = this.getStudentsFromLocalSrotage();
        var index = this.teacherList.findIndex(function (el) {
            return el.teacherName === teacherDel.teacherName;
        });
        this.teacherList.splice(index, 1);
        this.setStudentToLocalStorage(this.teacherList);
    };
    StudentService.prototype.getStudentsByTeacherName = function (name) {
        var students;
        this.teacherList = this.getStudentsFromLocalSrotage();
        this.teacherList.forEach(function (teacher) {
